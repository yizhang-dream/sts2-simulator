...
def is_sovereign_blade(card: CardInstance | None) -> bool:
    # card 可合法为 None(如怪物攻击 active_card_source=None):无来源卡
    # 不可能是 SOVEREIGN_BLADE(2026-09-06 弱池首跑实锤,act1_weak chomp
    # × CONQUEROR power 路径;调用方 remaining_a:655 已 getattr default None)
